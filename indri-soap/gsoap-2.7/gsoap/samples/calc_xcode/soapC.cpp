...
SOAP_SOURCE_STAMP("@(#) soapC.cpp ver 2.7.10 2008-01-27 19:40:54 GMT")
...
{	switch (p->type)
	...
	case SOAP_TYPE_ns__mulResponse:
		if (p->size < 0)
			delete (struct ns__mulResponse*)p->ptr;
		else
			delete[] (struct ns__mulResponse*)p->ptr;
		break;
	case SOAP_TYPE_ns__mul:
		if (p->size < 0)
			delete (struct ns__mul*)p->ptr;
		else
			delete[] (struct ns__mul*)p->ptr;
		break;
	case SOAP_TYPE_ns__divResponse:
		if (p->size < 0)
			delete (struct ns__divResponse*)p->ptr;
		else
			delete[] (struct ns__divResponse*)p->ptr;
		break;
	case SOAP_TYPE_ns__div:
		if (p->size < 0)
			delete (struct ns__div*)p->ptr;
		else
			delete[] (struct ns__div*)p->ptr;
		break;
	case SOAP_TYPE_ns__powResponse:
		if (p->size < 0)
			delete (struct ns__powResponse*)p->ptr;
		else
			delete[] (struct ns__powResponse*)p->ptr;
		break;
	case SOAP_TYPE_ns__pow:
		if (p->size < 0)
			delete (struct ns__pow*)p->ptr;
		else
			delete[] (struct ns__pow*)p->ptr;
		break;
	case SOAP_TYPE_SOAP_ENV__Header:
...
{
	register int id = soap_embed(soap, (void*)a, NULL, 0, tag, SOAP_TYPE_ns__pow);
	if (soap_out_ns__pow(soap, tag, id, a, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC3 struct ns__pow * SOAP_FMAC4 soap_in_ns__pow(struct soap *soap, const char *tag, struct ns__pow *a, const char *type)
{
	...
	if (soap_element_begin_in(soap, tag, 0, type))
		return NULL;
	a = (struct ns__pow *)soap_id_enter(soap, soap->id, a, SOAP_TYPE_ns__pow, sizeof(struct ns__pow), 0, NULL, NULL, NULL);
	if (!a)
		return NULL;
	...
	{	a = (struct ns__pow *)soap_id_forward(soap, soap->href, (void*)a, 0, SOAP_TYPE_ns__pow, 0, sizeof(struct ns__pow), 0, NULL);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
...
SOAP_FMAC5 struct ns__pow * SOAP_FMAC6 soap_new_ns__pow(struct soap *soap, int n)
{	return soap_instantiate_ns__pow(soap, n, NULL, NULL, NULL);
}

SOAP_FMAC5 void SOAP_FMAC6 soap_delete_ns__pow(struct soap *soap, struct ns__pow *p)
{	soap_delete(soap, p);
}

SOAP_FMAC3 struct ns__pow * SOAP_FMAC4 soap_instantiate_ns__pow(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "soap_instantiate_ns__pow(%d, %s, %s)\n", n, type?type:"", arrayType?arrayType:""));
	struct soap_clist *cp = soap_link(soap, NULL, SOAP_TYPE_ns__pow, n, soap_fdelete);
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)new struct ns__pow;
		if (size)
			*size = sizeof(struct ns__pow);
	}
	else
	{	cp->ptr = (void*)new struct ns__pow[n];
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
{
	register int id = soap_embed(soap, (void*)a, NULL, 0, tag, SOAP_TYPE_ns__powResponse);
	if (soap_out_ns__powResponse(soap, tag, id, a, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC3 struct ns__powResponse * SOAP_FMAC4 soap_in_ns__powResponse(struct soap *soap, const char *tag, struct ns__powResponse *a, const char *type)
{
	...
	if (soap_element_begin_in(soap, tag, 0, type))
		return NULL;
	a = (struct ns__powResponse *)soap_id_enter(soap, soap->id, a, SOAP_TYPE_ns__powResponse, sizeof(struct ns__powResponse), 0, NULL, NULL, NULL);
	if (!a)
		return NULL;
	...
	{	a = (struct ns__powResponse *)soap_id_forward(soap, soap->href, (void*)a, 0, SOAP_TYPE_ns__powResponse, 0, sizeof(struct ns__powResponse), 0, NULL);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
	return a;
...
SOAP_FMAC5 struct ns__powResponse * SOAP_FMAC6 soap_new_ns__powResponse(struct soap *soap, int n)
{	return soap_instantiate_ns__powResponse(soap, n, NULL, NULL, NULL);
}

SOAP_FMAC5 void SOAP_FMAC6 soap_delete_ns__powResponse(struct soap *soap, struct ns__powResponse *p)
{	soap_delete(soap, p);
}

SOAP_FMAC3 struct ns__powResponse * SOAP_FMAC4 soap_instantiate_ns__powResponse(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "soap_instantiate_ns__powResponse(%d, %s, %s)\n", n, type?type:"", arrayType?arrayType:""));
	struct soap_clist *cp = soap_link(soap, NULL, SOAP_TYPE_ns__powResponse, n, soap_fdelete);
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)new struct ns__powResponse;
		if (size)
			*size = sizeof(struct ns__powResponse);
	}
	else
	{	cp->ptr = (void*)new struct ns__powResponse[n];
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
{
	register int id = soap_embed(soap, (void*)a, NULL, 0, tag, SOAP_TYPE_ns__div);
	if (soap_out_ns__div(soap, tag, id, a, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC3 struct ns__div * SOAP_FMAC4 soap_in_ns__div(struct soap *soap, const char *tag, struct ns__div *a, const char *type)
{
	...
	if (soap_element_begin_in(soap, tag, 0, type))
		return NULL;
	a = (struct ns__div *)soap_id_enter(soap, soap->id, a, SOAP_TYPE_ns__div, sizeof(struct ns__div), 0, NULL, NULL, NULL);
	if (!a)
		return NULL;
	...
	{	a = (struct ns__div *)soap_id_forward(soap, soap->href, (void*)a, 0, SOAP_TYPE_ns__div, 0, sizeof(struct ns__div), 0, NULL);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
	if ((soap->mode & SOAP_XML_STRICT) && (soap_flag_a > 0 || soap_flag_b > 0))
...
SOAP_FMAC5 struct ns__div * SOAP_FMAC6 soap_new_ns__div(struct soap *soap, int n)
{	return soap_instantiate_ns__div(soap, n, NULL, NULL, NULL);
}

SOAP_FMAC5 void SOAP_FMAC6 soap_delete_ns__div(struct soap *soap, struct ns__div *p)
{	soap_delete(soap, p);
}

SOAP_FMAC3 struct ns__div * SOAP_FMAC4 soap_instantiate_ns__div(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "soap_instantiate_ns__div(%d, %s, %s)\n", n, type?type:"", arrayType?arrayType:""));
	struct soap_clist *cp = soap_link(soap, NULL, SOAP_TYPE_ns__div, n, soap_fdelete);
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)new struct ns__div;
		if (size)
			*size = sizeof(struct ns__div);
	}
	else
	{	cp->ptr = (void*)new struct ns__div[n];
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
{
	register int id = soap_embed(soap, (void*)a, NULL, 0, tag, SOAP_TYPE_ns__divResponse);
	if (soap_out_ns__divResponse(soap, tag, id, a, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC3 struct ns__divResponse * SOAP_FMAC4 soap_in_ns__divResponse(struct soap *soap, const char *tag, struct ns__divResponse *a, const char *type)
{
	...
	if (soap_element_begin_in(soap, tag, 0, type))
		return NULL;
	a = (struct ns__divResponse *)soap_id_enter(soap, soap->id, a, SOAP_TYPE_ns__divResponse, sizeof(struct ns__divResponse), 0, NULL, NULL, NULL);
	if (!a)
		return NULL;
	...
	{	a = (struct ns__divResponse *)soap_id_forward(soap, soap->href, (void*)a, 0, SOAP_TYPE_ns__divResponse, 0, sizeof(struct ns__divResponse), 0, NULL);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
	return a;
...
SOAP_FMAC5 struct ns__divResponse * SOAP_FMAC6 soap_new_ns__divResponse(struct soap *soap, int n)
{	return soap_instantiate_ns__divResponse(soap, n, NULL, NULL, NULL);
}

SOAP_FMAC5 void SOAP_FMAC6 soap_delete_ns__divResponse(struct soap *soap, struct ns__divResponse *p)
{	soap_delete(soap, p);
}

SOAP_FMAC3 struct ns__divResponse * SOAP_FMAC4 soap_instantiate_ns__divResponse(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	DBGLOG(TEST, SOAP_MESSAGE(fdebug, "soap_instantiate_ns__divResponse(%d, %s, %s)\n", n, type?type:"", arrayType?arrayType:""));
	struct soap_clist *cp = soap_link(soap, NULL, SOAP_TYPE_ns__divResponse, n, soap_fdelete);
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)new struct ns__divResponse;
		if (size)
			*size = sizeof(struct ns__divResponse);
	}
	else
	{	cp->ptr = (void*)new struct ns__divResponse[n];
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put_ns__mul(struct soap *soap, const struct ns__mul *a, const char *tag, const char *type)
{
	...
	if (soap_out_ns__mul(soap, tag, id, a, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC3 struct ns__mul * SOAP_FMAC4 soap_in_ns__mul(struct soap *soap, const char *tag, struct ns__mul *a, const char *type)
{
	...
	if (soap_element_begin_in(soap, tag, 0, type))
		return NULL;
	a = (struct ns__mul *)soap_id_enter(soap, soap->id, a, SOAP_TYPE_ns__mul, sizeof(struct ns__mul), 0, NULL, NULL, NULL);
	if (!a)
		return NULL;
	...
	{	a = (struct ns__mul *)soap_id_forward(soap, soap->href, (void*)a, 0, SOAP_TYPE_ns__mul, 0, sizeof(struct ns__mul), 0, NULL);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
	if ((soap->mode & SOAP_XML_STRICT) && (soap_flag_a > 0 || soap_flag_b > 0))
...
SOAP_FMAC5 struct ns__mul * SOAP_FMAC6 soap_new_ns__mul(struct soap *soap, int n)
{	return soap_instantiate_ns__mul(soap, n, NULL, NULL, NULL);
}

SOAP_FMAC5 void SOAP_FMAC6 soap_delete_ns__mul(struct soap *soap, struct ns__mul *p)
{	soap_delete(soap, p);
}

SOAP_FMAC3 struct ns__mul * SOAP_FMAC4 soap_instantiate_ns__mul(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)new struct ns__mul;
		if (size)
			*size = sizeof(struct ns__mul);
	}
	else
	{	cp->ptr = (void*)new struct ns__mul[n];
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put_ns__mulResponse(struct soap *soap, const struct ns__mulResponse *a, const char *tag, const char *type)
{
	...
	if (soap_out_ns__mulResponse(soap, tag, id, a, type))
		return soap->error;
	return soap_putindependent(soap);
}
...
SOAP_FMAC3 struct ns__mulResponse * SOAP_FMAC4 soap_in_ns__mulResponse(struct soap *soap, const char *tag, struct ns__mulResponse *a, const char *type)
{
	...
	if (soap_element_begin_in(soap, tag, 0, type))
		return NULL;
	a = (struct ns__mulResponse *)soap_id_enter(soap, soap->id, a, SOAP_TYPE_ns__mulResponse, sizeof(struct ns__mulResponse), 0, NULL, NULL, NULL);
	if (!a)
		return NULL;
	...
	{	a = (struct ns__mulResponse *)soap_id_forward(soap, soap->href, (void*)a, 0, SOAP_TYPE_ns__mulResponse, 0, sizeof(struct ns__mulResponse), 0, NULL);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
	return a;
...
SOAP_FMAC5 struct ns__mulResponse * SOAP_FMAC6 soap_new_ns__mulResponse(struct soap *soap, int n)
{	return soap_instantiate_ns__mulResponse(soap, n, NULL, NULL, NULL);
}

SOAP_FMAC5 void SOAP_FMAC6 soap_delete_ns__mulResponse(struct soap *soap, struct ns__mulResponse *p)
{	soap_delete(soap, p);
}

SOAP_FMAC3 struct ns__mulResponse * SOAP_FMAC4 soap_instantiate_ns__mulResponse(struct soap *soap, int n, const char *type, const char *arrayType, size_t *size)
{
	...
	if (!cp)
		return NULL;
	if (n < 0)
	{	cp->ptr = (void*)new struct ns__mulResponse;
		if (size)
			*size = sizeof(struct ns__mulResponse);
	}
	else
	{	cp->ptr = (void*)new struct ns__mulResponse[n];
		if (!cp->ptr)
		{	soap->error = SOAP_EOM;
			return NULL;
		}
