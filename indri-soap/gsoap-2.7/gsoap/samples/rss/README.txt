Example RSS client and server. As a command-line client displays RSS feeds in
text format. As a server reformats formats RSS feeds in HTML to be displayed in
your web pages via a JavaScript (see below).
