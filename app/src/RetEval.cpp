...
<li> The CORI (inquery) retrieval model
...
<li>For COS:
<ol>
<li> <tt>feedbackPosCoeff</tt>: the coefficient for positive terms in (positive) Rocchio feedback as for the TFIDF model.
<li> <tt>L2File</tt> - File containing precomputed L2 Norms (generated with GenL2Norm).
</ol>
...
int AppMain(int argc, char *argv[]) {
  ...
  case LocalParameter::CORIDOC:
    ...
    break;
  case LocalParameter::COS: 
    CosSimParameter::get();
    model = new CosSimRetMethod(*ind, CosSimParameter::L2NormFile, accumulator);
  ...
  while (qryStream->hasMore()) {
	...
	break;
      default:
	throw Exception("RetEval:FB", "unknown retModel parameter");
	break;
      }
    }
