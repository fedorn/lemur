...
<ul>
<li>  Add Stopper for source/and target language.
<li>  Add access to stemmer for source, target language.
<li>  Add parameter file processing (for specifying stemmer, etc).
<li>  Add parameter to specify starting in counts domain
</ul>
*/
/*
  author: dmf
