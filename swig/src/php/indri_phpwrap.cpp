...
static int le_swig__p_std__vectorTindri__api__ScoredExtentResult_t=0; /* handle for _p_std__vectorTindri__api__ScoredExtentResult_t */
...
static int le_swig__p_std__vectorTlemur__api__DOCID_T_t=0; /* handle for _p_std__vectorTlemur__api__DOCID_T_t */
...
static int le_swig__p_std__vectorTstd__string_t=0; /* handle for _p_std__vectorTstd__string_t */
...
static ZEND_RSRC_DTOR_FUNC(_wrap_destroy_p_std__vectorTindri__api__ScoredExtentResult_t) {
  /* No destructor for simple type _p_std__vectorTindri__api__ScoredExtentResult_t */
}
/* NEW Destructor style */
...
static ZEND_RSRC_DTOR_FUNC(_wrap_destroy_p_std__vectorTlemur__api__DOCID_T_t) {
  /* No destructor for simple type _p_std__vectorTlemur__api__DOCID_T_t */
}
/* NEW Destructor style */
...
static ZEND_RSRC_DTOR_FUNC(_wrap_destroy_p_std__vectorTstd__string_t) {
  /* No destructor for simple type _p_std__vectorTstd__string_t */
}
/* NEW Destructor style */
...
static function_entry indri_functions[] = {
{NULL, NULL, NULL}
};
