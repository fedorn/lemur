...
ZEND_NAMED_FUNCTION(_wrap_QueryExpander_runExpandedQuery__SWIG_0) {
  ...
  {
    convert_to_string_ex(args[1]);
    arg2 = std::string(Z_STRVAL_PP(args[1]),Z_STRLEN_PP(args[1]));
  }
  {
    /*@SWIG:CONVERT_INT_IN@*/
    convert_to_long_ex(args[2]);
...
static function_entry libindri_php_functions[] = {
 ZEND_NAMED_FE(termextent_begin_set,_wrap_TermExtent_begin_set,NULL)
 ZEND_NAMED_FE(termextent_begin_get,_wrap_TermExtent_begin_get,NULL)
 ZEND_NAMED_FE(termextent_end_set,_wrap_TermExtent_end_set,NULL)
 ZEND_NAMED_FE(termextent_end_get,_wrap_TermExtent_end_get,NULL)
