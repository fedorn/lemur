...
#ifdef ZTS
#define ErrorMsg() TSRMG(indri_globals_id, zend_indri_globals *, error_msg )
#define ErrorCode() TSRMG(indri_globals_id, zend_indri_globals *, error_code )
#else
#define ErrorMsg() (indri_globals.error_msg)
#define ErrorCode() (indri_globals.error_code)
#endif

static void indri_init_globals(zend_indri_globals *indri_globals ) {
  indri_globals->error_msg = default_error_msg;
  indri_globals->error_code = default_error_code;
}
static void indri_destroy_globals(zend_indri_globals *indri_globals) { }
...
static zend_function_entry ParsedDocument_functions[] = {
 ZEND_NAMED_FE(parseddocument_getcontent,_wrap_ParsedDocument_getContent, NULL)
 ZEND_NAMED_FE(getcontent,_wrap_ParsedDocument_getContent, NULL)
 ZEND_NAMED_FE(new_parseddocument,_wrap_new_ParsedDocument, NULL)
 ZEND_NAMED_FE(parseddocument,_wrap_new_ParsedDocument, NULL)
   { NULL, NULL, NULL}
};
/* Function entries for QueryAnnotationNode */
static zend_function_entry QueryAnnotationNode_functions[] = {
 ZEND_NAMED_FE(new_queryannotationnode,_wrap_new_QueryAnnotationNode, NULL)
 ZEND_NAMED_FE(queryannotationnode,_wrap_new_QueryAnnotationNode, NULL)
   { NULL, NULL, NULL}
};
/* Function entries for QueryAnnotation */
static zend_function_entry QueryAnnotation_functions[] = {
 ZEND_NAMED_FE(queryannotation_getquerytree,_wrap_QueryAnnotation_getQueryTree, NULL)
 ZEND_NAMED_FE(getquerytree,_wrap_QueryAnnotation_getQueryTree, NULL)
 ZEND_NAMED_FE(queryannotation_getannotations,_wrap_QueryAnnotation_getAnnotations, NULL)
 ZEND_NAMED_FE(getannotations,_wrap_QueryAnnotation_getAnnotations, NULL)
 ZEND_NAMED_FE(queryannotation_getresults,_wrap_QueryAnnotation_getResults, NULL)
 ZEND_NAMED_FE(getresults,_wrap_QueryAnnotation_getResults, NULL)
 ZEND_NAMED_FE(new_queryannotation,_wrap_new_QueryAnnotation, NULL)
 ZEND_NAMED_FE(queryannotation,_wrap_new_QueryAnnotation, NULL)
   { NULL, NULL, NULL}
};
/* Function entries for QueryEnvironment */
static zend_function_entry QueryEnvironment_functions[] = {
 ZEND_NAMED_FE(queryenvironment_addserver,_wrap_QueryEnvironment_addServer, NULL)
 ZEND_NAMED_FE(addserver,_wrap_QueryEnvironment_addServer, NULL)
 ZEND_NAMED_FE(queryenvironment_addindex,_wrap_QueryEnvironment_addIndex, NULL)
 ZEND_NAMED_FE(addindex,_wrap_QueryEnvironment_addIndex, NULL)
 ZEND_NAMED_FE(queryenvironment_close,_wrap_QueryEnvironment_close, NULL)
 ZEND_NAMED_FE(close,_wrap_QueryEnvironment_close, NULL)
 ZEND_NAMED_FE(queryenvironment_setmemory,_wrap_QueryEnvironment_setMemory, NULL)
 ZEND_NAMED_FE(setmemory,_wrap_QueryEnvironment_setMemory, NULL)
 ZEND_NAMED_FE(queryenvironment_setscoringrules,_wrap_QueryEnvironment_setScoringRules, NULL)
 ZEND_NAMED_FE(setscoringrules,_wrap_QueryEnvironment_setScoringRules, NULL)
 ZEND_NAMED_FE(queryenvironment_setstopwords,_wrap_QueryEnvironment_setStopwords, NULL)
 ZEND_NAMED_FE(setstopwords,_wrap_QueryEnvironment_setStopwords, NULL)
 ZEND_NAMED_FE(queryenvironment_runquery,_wrap_QueryEnvironment_runQuery, NULL)
 ZEND_NAMED_FE(runquery,_wrap_QueryEnvironment_runQuery, NULL)
 ZEND_NAMED_FE(queryenvironment_runquerydocset,_wrap_QueryEnvironment_runQuerydocset, NULL)
 ZEND_NAMED_FE(runquerydocset,_wrap_QueryEnvironment_runQuerydocset, NULL)
 ZEND_NAMED_FE(queryenvironment_runannotatedquery,_wrap_QueryEnvironment_runAnnotatedQuery, NULL)
 ZEND_NAMED_FE(runannotatedquery,_wrap_QueryEnvironment_runAnnotatedQuery, NULL)
 ZEND_NAMED_FE(queryenvironment_runannotatedquerydocset,_wrap_QueryEnvironment_runAnnotatedQuerydocset, NULL)
 ZEND_NAMED_FE(runannotatedquerydocset,_wrap_QueryEnvironment_runAnnotatedQuerydocset, NULL)
 ZEND_NAMED_FE(queryenvironment_documentsdocids,_wrap_QueryEnvironment_documentsdocids, NULL)
 ZEND_NAMED_FE(documentsdocids,_wrap_QueryEnvironment_documentsdocids, NULL)
 ZEND_NAMED_FE(queryenvironment_documents,_wrap_QueryEnvironment_documents, NULL)
 ZEND_NAMED_FE(documents,_wrap_QueryEnvironment_documents, NULL)
 ZEND_NAMED_FE(queryenvironment_documentmetadatadocids,_wrap_QueryEnvironment_documentMetadatadocids, NULL)
 ...
 ZEND_NAMED_FE(onetermcount,_wrap_QueryEnvironment_onetermCount, NULL)
 ZEND_NAMED_FE(queryenvironment_stemcount,_wrap_QueryEnvironment_stemCount, NULL)
 ZEND_NAMED_FE(stemcount,_wrap_QueryEnvironment_stemCount, NULL)
 ZEND_NAMED_FE(queryenvironment_termfieldcount,_wrap_QueryEnvironment_termFieldCount, NULL)
 ZEND_NAMED_FE(termfieldcount,_wrap_QueryEnvironment_termFieldCount, NULL)
 ZEND_NAMED_FE(queryenvironment_stemfieldcount,_wrap_QueryEnvironment_stemFieldCount, NULL)
 ZEND_NAMED_FE(stemfieldcount,_wrap_QueryEnvironment_stemFieldCount, NULL)
 ZEND_NAMED_FE(queryenvironment_fieldlist,_wrap_QueryEnvironment_fieldList, NULL)
 ZEND_NAMED_FE(fieldlist,_wrap_QueryEnvironment_fieldList, NULL)
 ZEND_NAMED_FE(queryenvironment_documentcount,_wrap_QueryEnvironment_documentCount, NULL)
