...
SWIGINTERN void std_vector_Sl_lemur_api_IndexedReal_Sg__setitem(std::vector<lemur::api::IndexedReal > *self,int index,std::vector<lemur::api::IndexedReal >::value_type const &value){
        if (index>=0 && index<(int)self->size())
          (*self)[index] = value;
        else
          throw std::out_of_range("index");
...
SWIGINTERN void std_vector_Sl_lemur_api_IndexedReal_Sg__Insert(std::vector<lemur::api::IndexedReal > *self,int index,std::vector<lemur::api::IndexedReal >::value_type const &value){
...
SWIGINTERN void std_vector_Sl_lemur_api_TMatch_Sg__setitem(std::vector<lemur::api::TMatch > *self,int index,std::vector<lemur::api::TMatch >::value_type const &value){
        if (index>=0 && index<(int)self->size())
          (*self)[index] = value;
        else
          throw std::out_of_range("index");
...
SWIGINTERN void std_vector_Sl_lemur_api_TMatch_Sg__Insert(std::vector<lemur::api::TMatch > *self,int index,std::vector<lemur::api::TMatch >::value_type const &value){
        if (index>=0 && index<(int)self->size()+1)
          self->insert(self->begin()+index, value);
        else
          throw std::out_of_range("index");
...
SWIGEXPORT void * SWIGSTDCALL CSharp_IRVector_getitemcopy(void * jarg1, int jarg2) {
  ...
  jresult = new lemur::api::IndexedReal((lemur::api::IndexedReal &)result); 
  return jresult;
}
...
SWIGEXPORT void * SWIGSTDCALL CSharp_TMatchVector_getitemcopy(void * jarg1, int jarg2) {
  ...
  jresult = new lemur::api::TMatch((lemur::api::TMatch &)result); 
  return jresult;
}
