...
public class IntVector : IDisposable, System.Collections.IEnumerable {
  ...
  public void Add(int x) {
    indri_csharpPINVOKE.IntVector_Add(swigCPtr, x);
  }
  ...
  private void setitem(int index, int val) {
    indri_csharpPINVOKE.IntVector_setitem(swigCPtr, index, val);
    if (indri_csharpPINVOKE.SWIGPendingException.Pending) throw indri_csharpPINVOKE.SWIGPendingException.Retrieve();
  }
  ...
  public void Insert(int index, int x) {
    indri_csharpPINVOKE.IntVector_Insert(swigCPtr, index, x);
    if (indri_csharpPINVOKE.SWIGPendingException.Pending) throw indri_csharpPINVOKE.SWIGPendingException.Retrieve();
  }
