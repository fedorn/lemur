...
class indri_csharpPINVOKE {
  ...
  [DllImport("lemur_csharp", EntryPoint="CSharp_RMExpanderUpcast")]
  public static extern IntPtr RMExpanderUpcast(IntPtr objectRef);

  [DllImport("lemur_csharp", EntryPoint="CSharp_PonteExpanderUpcast")]
