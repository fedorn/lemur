...
/*!
*/
class KeyfileClusterDB : public ClusterDB {

public:
  /// initialize
  KeyfileClusterDB(const Index *ind, 
		    const string &name, 		   
...
private:
  ...
  mutable Keyfile doc2cluster;
  mutable Keyfile clustersKey;
  void init(const string &name);
  void addC2D(int cid, const vector<DOCID_T> &dids);
};
#endif
