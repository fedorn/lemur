...
InvPassagePushIndex::InvPassagePushIndex(const string &prefix, int psgSize,
...
bool InvPassagePushIndex::beginDoc(const DocumentProps* dp){
  if (dp == NULL)
    return false;
  //  curDoc = dp;
...
bool InvPassagePushIndex::addTerm(const Term& t){
