...
ObjectStream::ObjectStream(XRef *xref, int objStrNumA) {
  ...
  parser = new xpdf::Parser(xref, new Lexer(xref, str));
...
GBool XRef::readXRefTable(xpdf::Parser *parser, Guint *pos) {
  XRefEntry entry;
  GBool more;
  Object obj, obj2;
  Guint pos2;
