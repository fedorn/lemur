...
void indri::infnet::ExtentParentNode::prepare( int documentID ) {
  _extents.clear();
...
int indri::infnet::ExtentParentNode::nextCandidateDocument() {
...
void indri::infnet::ExtentParentNode::annotate( class Annotator& annotator, int documentID, indri::index::Extent &extent ) {
